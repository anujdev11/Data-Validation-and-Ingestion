...
@Repository
public class SystemUserDaoImpl extends JdbcDaoSupport implements SystemUserDao {

    Connection connection;
    final DataSource dataSource;
    final JdbcTemplate jdbcTemplate;

    public SystemUserDaoImpl(JdbcTemplate jdbcTemplate, DataSource dataSource) {
